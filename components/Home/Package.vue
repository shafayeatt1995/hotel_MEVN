    ...
    <div class="container relative lg:mt-24 mt-16 mx-auto">
          ...
          <div class="p-4">
            ...
            <div class="flex items-center mt-2">
              ...
              <ul class="text-lg font-medium text-amber-400 list-none ms-2">
                ...
                <li class="inline text-black dark:text-white text-sm">
                  5.0(30)
                </li>
              </ul>
            </div>
            ...
            >
              <h5 class="text-lg font-medium text-blue-500">$ 58 / Day</h5>
      ...
      <div class="mt-6 text-center">
        <a
          ...
          class="text-slate-400 hover:text-blue-500 inline-block"
